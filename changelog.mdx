...
*Improved offline support and startup observability for capsule workers.*
  ...
  offline support and startup observability for capsule workers.
### Added
...
*Improved chain sync robustness and streamlined network module logic.*
  ...
  chain sync robustness and streamlined network module logic.
### Added
...
<Update label="2025-07-10" description="[PROTOCOL:0.8.4]" tags={["Improved"]}>
...
<Update label="2025-07-09" description="[PROTOCOL:0.8.3]" tags={["Improved"]}>
...
<Update label="2025-07-03" description="[CAPSULE:0.1.33]" tags={["Improved"]}>
*Improved process management with graceful shutdown and defined exit codes.*

  process management with graceful shutdown and defined exit codes.
### Added
...
<Update label="2025-07-02" description="[CAPSULE:0.1.32]" tags={["Improved"]}>
...
<Update label="2025-07-01" description="[PROTOCOL:0.8.2]" tags={["Improved"]}>
...
<Update label="2025-06-24" description="[PROTOCOL:0.8.1]" tags={["Improved"]}>
*Improved transaction reliability and deadline handling through buffer tuning and multi-bootstrap support.*

  transaction reliability and deadline handling through buffer tuning and multi-bootstrap support.
### Added
...
<Update label="2025-05-20" description="[CAPSULE:0.1.27]" tags={["Improved"]}>
...
<Update label="2025-05-12" description="[PROTOCOL:0.5.4]" tags={["Improved"]}>
...
<Update label="2025-05-07" description="[CAPSULE:0.1.22]" tags={["Improved"]}>
...
<Update label="2025-05-01" description="[PROTOCOL:0.5.2]" tags={["Improved"]}>
...
<Update label="2025-05-01" description="[PROTOCOL:0.5.1]" tags={["Improved"]}>
*Improved handling for empty tokenizer values in intents.*

  handling for empty tokenizer values in intents.
...
<Update label="2025-04-30" description="[PROTOCOL:0.5.0]" tags={["Improved"]}>
...
<Update label="2025-04-30" description="[CAPSULE:0.1.21]" tags={["Improved"]}>
...
<Update label="2025-04-11" description="[CAPSULE:0.1.20]" tags={["Improved"]}>
*Improved system prompt and added error handling for model outputs.*

  system prompt and added error handling for model outputs.
...
<Update label="2025-04-11" description="[CAPSULE:0.1.19]" tags={["Improved"]}>
...
*Improved token handling and pre-checks before participation.*
  ...
  token handling and pre-checks before participation.
### Added
...
<Update label="2025-04-10" description="[CAPSULE:0.1.18]" tags={["Improved"]}>
...
<Update label="2025-04-09" description="[CAPSULE:0.1.17]" tags={["Improved"]}>
...
<Update label="2025-04-08" description="[CAPSULE:0.1.16]" tags={["Improved"]}>
...
- Gas efficiency and fixed retry logic.
...
<Update label="2025-03-20" description="[CAPSULE:0.1.13]" tags={["Improved"]}>
...
<Update label="2025-03-19" description="[CAPSULE:0.1.12]" tags={["Improved"]}>
...
<Update label="2025-03-13" description="[PROTOCOL:0.2.2]" tags={["Improved"]}>
...
<Update label="2025-03-12" description="[PROTOCOL:0.2.0]" tags={["Improved"]}>
...
<Update label="2025-03-11" description="[PROTOCOL:0.1.33]" tags={["Improved"]}>
...
<Update label="2025-03-10" description="[PROTOCOL:0.1.32]" tags={["Improved"]}>
*Improved swarm stability, fixed reconnection and ranking issues, and enhanced logging.*

  swarm stability, fixed reconnection and ranking issues, and enhanced logging.
### Added
