...
2. If selected, you will receive an email and an initial mini-drop of tokens to the Monad address you provided in the form. You will have 72 hours to set up and launch your node following the provided instructions.
3. Once your node is successfully operational, you will be able to continue to participate in the network and receive additional token drops.
